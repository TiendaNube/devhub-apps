...
<Alert appearance="warning" title="📅 30 de agosto de 2026 — el uso del NubeSDK pasa a ser obligatorio para nuevas instalaciones">
   <Text>A partir del <Text as="span" fontWeight="bold">30 de agosto de 2026</Text>, las apps que no estén desarrolladas con el <Text as="span" fontWeight="bold">NubeSDK</Text> y no estén en la <Text as="span" fontWeight="bold">whitelist</Text> no podrán recibir nuevas instalaciones. Las tiendas que ya tienen la app instalada <Text as="span" fontWeight="bold">no se verán afectadas</Text>. Estamos llevando progresivamente todas las tiendas al modelo con SDK.</Text>
   <br />
   <Text>👉 <Text as="span" fontWeight="bold">¿Quieres validar tu app antes del plazo?</Text> Ponte en contacto para que agreguemos la tag en tu tienda de prueba y puedas validar tu app en el nuevo modelo.</Text>
   <br />
...
- ✅ **30 de agosto de 2026** — las nuevas instalaciones quedan **bloqueadas** para apps sin SDK que no estén en la whitelist.
