...
These images should showcase the app's screens and highlight its main features, sparking the retailer's interest in installing it. The same images are shared in all languages, so if your app is published in all countries, the text in the images must be in both Portuguese and Spanish.

![imagens-aplicativo](../../../../../static/img/en/imagens-aplicativo.png "imagens-aplicativo")
...
![cobranca](../../../../../static/img/en/cobranca.png "cobranca")
...
Nuvemshop has created a guide to ensure your description includes as many keywords as possible, guaranteeing a good return in the App Store search when merchants search for a feature or need that your app solves. Use this exact structure:
...
If you have one, you can insert a short video introducing the app. Audiovisual media enriches your page and encourages the user to stay longer on the page.
...
It is mandatory to provide the Nuvemshop team, during the approval phase along with the other shared artifacts, with the FAQ document containing the most frequently asked questions about your application.
